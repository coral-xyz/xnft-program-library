...
function createRedux<State, Actions>(reducer: Reducer<State, Actions>, initialState: State) {
  ...
  const connect = <P, SP>(
    ...
    props: P
        ...
        const [selection, updateSelection] = useState<SP | null>(() => currentSelector(state, props, null));
...
type Thunk<State, Actions> = (dispatch: ThunkDispatch<State, Actions>, getState: () => State) => void;
type ThunkDispatch<State, Actions> = (action: Actions | Thunk<State, Actions>) => void;
