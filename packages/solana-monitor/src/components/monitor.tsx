    ...
    <View style={{ height: "100%" }}>
      ...
      >
        ...
        <View style={{flex: "1", paddingTop: "11px", paddingLeft:"12px", paddingRight: "11px", width: "166px", marginLeft: "16px", marginTop: "20px", background: "rgba(255, 255, 255, 0.04)", border: "1px solid rgba(255, 255, 255, 0.04)", backdropFilter: "blur(30px)", borderRadius: "8px"}}>
          ...
          <Text style={{fontWeight: "400", fontSize: "12px", lineHeight: "150%", color: "rgba(255,255,255, 0.85)", marginTop: "15px", marginBottom: "16px"}}>View {'>'}</Text>
        </View>
      ...
      <View style={{display: "flex", flexDirection: "row", marginLeft:"16px", marginTop:"10px"}}>
        <Text style={{display: "flex", flexDirection: "row", fontWeight: "400", fontSize: "14px", lineHeight: "150%", color: "rgba(255,255,255,0.85)"}}>TPS <Text style={{marginLeft:"4px", fontWeight: "700", fontSize: "14px", lineHeight: "150%", color: "white"}}>2100.1</Text></Text>
        <Text style={{display: "flex", flexDirection: "row", marginLeft:"186px", fontWeight: "400", fontSize: "14px", lineHeight: "150%", color: "rgba(255,255,255,0.85)"}}>Ping <Text style={{marginLeft:"4px", fontWeight: "700", fontSize: "14px", lineHeight: "150%", color: "white"}}>2020.1</Text></Text>
      </View>
      ...
      <View style={{width: "90%", height: "1px", background: "rgba(255, 255, 255, 0.06)", marginLeft: "16px", marginRight: "16px"}}></View>
        ...
        <View style={{height: "144px", width: "90%", alignItems: "center", justifyContent: "center", background: 'white', marginTop: "7px", marginLeft: "20px", marginRight: "20px"}}>
        ...
        <View style={{display: "flex", flexDirection: "row", marginTop: "9px"}}>
          <View style={{display: "flex", flexDirection: "column", marginLeft:"16px"}}>
            ...
            <Text style={{fontStyle:"normal", fontWeight:"700", fontSize: "14px", lineHeight: "150%", color: "white"}}>75.24%</Text>
          </View>
          <View style={{display: "flex", flexDirection: "column", marginLeft:"211px"}}>
            ...
            <Text style={{fontStyle:"normal", fontWeight:"700", fontSize: "14px", lineHeight: "150%", color: "white"}}>1d 10h 11m</Text>
          </View>
        </View>
        <View style={{background: "gray", height: "8px", width:"90%", marginLeft: "16px", borderRadius: "2px", marginTop:"8px"}}>
          <View style={{width: "75%", height: "100%", borderRadius: "inherit", transition: "width .2s ease-in", background: "#0DD3E2"}}>
            
          </View>
        </View>
        <View style={{display: "flex", flexDirection: "row", marginTop: "8.26px", marginBottom: "20.6px"}}>
          <View style={{display: "flex", flexDirection: "column", marginLeft:"16px"}}>
            <Text style={{fontStyle:"normal", fontWeight:"400", fontSize: "14px", lineHeight: "150%", color: "rgba(255,255,255,0.85)"}}>#14567000</Text>
          </View>
          <View style={{display: "flex", flexDirection: "column", marginLeft:"191px"}}>
            <Text style={{fontStyle:"normal", fontWeight:"400", fontSize: "14px", lineHeight: "150%", color: "rgba(255,255,255,0.85)"}}>#14807000</Text>
          </View>
        </View>
    </View>
  );
