...
export function MonitorScreen() {
  ...
  return (
    <View style={{ height: "100%" }}>
      ...
      >
        {/* SOL Stuff */}
        <View style={{flex: "1", paddingTop: "11px", paddingLeft:"12px", paddingRight: "11px", width: "166px", marginLeft: "16px", marginTop: "20px", background: "rgba(255, 255, 255, 0.04)", border: "1px solid rgba(255, 255, 255, 0.04)", backdropFilter: "blur(30px)", borderRadius: "8px"}}>
          ...
          <View style={{display: "flex", flexDirection: "row", marginTop: "12px"}}>
            ...
            <Text style={{alignItems: "center", textAlign: "center", fontWeight: "500", marginTop: "5px", marginLeft:"4px", fontSize: "12px", lineHeight: "150%", color: "rgba(255,255,255, 0.85)"}}>
              / {convertToInternationalCurrencySystem(data?.data.solSupply.total)}
            </Text>
          </View>
          <View style={{display: "flex", flexDirection: "row", marginTop: "4px"}}>
            <Text style={{fontWeight: "700", fontSize: "12px", lineHeight: "150%", color: "#0DD3E2"}}>
          ...
          <Button style={{padding: "0px", background: "none", width: "0px", height: "0px", marginTop: "25px", marginBottom: "16px"}} onClick={() => {nav.push("sol_supply")}}><Text style={{fontWeight: "400", fontSize: "12px", lineHeight: "150%", color: "rgba(255,255,255, 0.85)"}}>View {'>'}</Text></Button>
        </View>
        ...
        <View style={{flex: "1", paddingTop: "11px", paddingLeft:"12px", paddingRight: "11px", width: "166px", marginLeft: "16px", marginTop: "20px", background: "rgba(255, 255, 255, 0.04)", border: "1px solid rgba(255, 255, 255, 0.04)", backdropFilter: "blur(30px)", borderRadius: "8px"}}>
          ...
          <View style={{display: "flex", flexDirection: "row", marginTop: "4px"}}>
             <Text style={{alignItems: "center", textAlign: "center", fontWeight: "500", fontSize: "12px", lineHeight: "150%", color: "rgba(255,255,255, 0.85)"}}>
              Delinquent stake:
            </Text>
            <Text style={{fontWeight: "700", fontSize: "12px", marginLeft:"4px", lineHeight: "150%", color: "#0DD3E2"}}>
            {convertToInternationalCurrencySystem(data?.data.solStakeOverview.totalSolDelinquent)}
            </Text>
          </View>
          <Button style={{padding: "0px", background: "none", width: "0px", height: "0px", marginTop: "25px", marginBottom: "16px"}} onClick={() => {nav.push("sol_stake")}}><Text style={{fontWeight: "400", fontSize: "12px", lineHeight: "150%", color: "rgba(255,255,255, 0.85)"}}>View {'>'}</Text></Button>
        </View>
      </View>
      <View style={{display: "flex", flexDirection: "row", marginLeft:"16px", marginTop: '20px'}}>
        ...
        <View style={{display: "flex", flexDirection: "column"}}>
          ...
          <View style={{background: "#0DD3E2", borderRadius: "1px", width: "69px", height:"4px", marginLeft:"5px"}}></View>
        </View>
      </View>
      ...
      <View style={{width: "90%", height: "1px", background: "rgba(255, 255, 255, 0.06)", marginLeft: "16px", marginRight: "16px"}}></View>
        <View style={{display: "flex", flexDirection: "row", marginTop: "14px", marginRight: "16px"}}>
          ...
          <View style={{display: "flex", flexDirection: "row", marginLeft: "120px"}}>
            <View style={{width: "45.51px", height:"24px",  background: "rgba(255, 255, 255, 0.04)", borderRadius: "4px", paddingLeft: "10px"}}>
              <Text style={{fontSize: "12px", fontWeight: "500", marginTop:"3px"}}>30m</Text>
            </View>
        ...
        <Iframe src={"https://h80vp2.csb.app/"}
        ...
        <View style={{display: "flex", flexDirection: "row", marginLeft:"16px", marginTop: '20px'}}>
          ...
          <View style={{display: "flex", flexDirection: "column"}}>
            ...
            <View style={{background: "#0DD3E2", borderRadius: "1px", width: "38px", height:"4px", marginLeft:"5px"}}></View>
          </View>
        </View>
        ...
        <View style={{display: "flex", flexDirection: "row", marginTop: "9px"}}>
          ...
          <View style={{display: "flex", flexDirection: "column", marginLeft:"211px"}}>
        ...
        <View style={{display: "flex", flexDirection: "row", marginTop: "8.26px", marginBottom: "20.6px"}}>
          ...
          <View style={{display: "flex", flexDirection: "column", marginLeft:"191px"}}>
