            ...
            return (
              <>
                <View style={{display: "flex", flexDirection: "row", alignItems: "center", marginTop: "20px", marginBottom: "16px"}}>
                    <Text style={{fontWeight: "600", fontSize: "16px"}}>{index + 1}</Text>
                    <Image 
                    ...
                    <View style={{width: "134px"}}>
                      <Text style={{marginLeft: "6px", fontWeight: "600", fontSize: "16px", lineHeight: "120%"}}>{item.data.collection}</Text>
                      <View style={{display: "flex", flewDirection :"row", marginTop: "3.5px"}}>
                        <Text style={{marginLeft: "6px", fontWeight: "400", fontSize: "14px", lineHeight: "120%", color: "rgba(255,255,255,0.65)"}}>Floor </Text>
                        <View
                          style={{ display: "flex", flexDirection: "row", gap: 5, marginLeft: "8px"}}
                        >
                          <Image
                            style={{
                              width: "20px",
                          ...
                          />
                          <Text
                            style={{fontWeight: "600", fontSize: "14px", lineHeight: "120%", marginTop: "2px",}}
                          >
                    ...
                    <View
                      style={{ display: "flex", flexDirection: "row", gap: 5, justifyContent: "right", marginLeft: "50px"}}
                    >
                      <Image
                        style={{
                          width: "20px",
                      ...
                      />
                      <Text
                        style={{fontWeight: "400", fontSize: "14px", lineHeight: "120%", marginTop: "2px",}}
                      >
                        {convertToInternationalCurrencySystem((item.volume / 10 ** 9))}
                      </Text>
                    </View>
                </View>
