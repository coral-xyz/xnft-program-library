...
export function StablecoinScreen() {
    const protocol_data = useSWR("https://stablecoins.llama.fi/stablecoins?includePrices=true", fetcher);
    console.log("protocol data: ", protocol_data?.data?.peggedAssets)
    const filtered = protocol_data?.data?.peggedAssets.filter((data, index) => data?.chainCirculating?.Solana != undefined && data?.chainCirculating?.Solana?.current?.peggedUSD > 100000);
    ...
    const solana_mcap = mcap?.data?.filter((data, index) => data?.gecko_id === "solana");
    ...
    <View style={{ height: "100%" }}>
      ...
      >
        ...
        <View style={{position: "fixed", marginTop: "10px", height: "136px", width: "140px", background: "#0DD3E2", borderRadius:"100px", opacity: "0.1", filter: "blur(25px)"}}></View>
          ...
          <View style={{display: "flex", flexDirection: "row", marginTop: "12px"}}>
            <Text style={{fontWeight: "700", fontSize: "18px", lineHeight: "150%", color: "white"}}>
              ${convertToInternationalCurrencySystem(solana_mcap?.[0].totalCirculatingUSD?.peggedUSD)}
            </Text>
            <Text style={{alignItems: "center", textAlign: "center", fontWeight: "500", marginTop: "5px", marginLeft:"4px", fontSize: "12px", lineHeight: "150%"}}>
              {}
            </Text>
          </View>
        </View>
        ...
        <View style={{position: "fixed", marginTop: "10px", height: "136px", width: "140px", background: "#0DD3E2", borderRadius:"100px", opacity: "0.1", filter: "blur(25px)"}}></View>
          ...
          <View style={{display: "flex", flexDirection: "row", marginTop: "12px"}}>
            <Text style={{fontWeight: "700", fontSize: "18px", lineHeight: "150%", color: "white"}}>
              {filtered ? ((filtered[1].chainCirculating?.Solana?.current?.peggedUSD / solana_mcap?.[0].totalCirculatingUSD?.peggedUSD)*100).toString().slice(0,4) : ""}%
            </Text>
            
          </View>
        </View>
      </View>
      <Text style={{fontStyle:"normal", fontWeight:"700", fontSize: "18px", lineHeight: "150%", color: "#FFFFFF", marginTop: "20px", marginLeft: "16px"}}>Stablecoin Ranking</Text>
      ...
      <View style={{display: "flex", flexDirection: "row", marginTop: "8px", marginLeft: "16px"}}>
        ...
        <Text style={{fontWeight: "400", fontSize: "12px", lineHeight: "150%", color: "rgba(255, 255, 255, 0.45)", marginLeft: "105px"}}>Type</Text>
        <Text style={{fontWeight: "400", fontSize: "12px", lineHeight: "150%", color: "rgba(255, 255, 255, 0.45)", marginLeft: "45px"}}>Circ USD</Text>
        <Text style={{fontWeight: "400", fontSize: "12px", lineHeight: "150%", color: "rgba(255, 255, 255, 0.45)", marginLeft: "25px"}}>Price</Text>
      </View>
      {filtered &&
              ...
              <>
                <View style={{display: "flex", flexDirection: "row", alignItems: "center", marginTop: "20px", marginBottom: "16px"}}>
                    ...
                    <View style={{width: "53px", justifyContent: "right", alignItems: "right"}}>
                      <Text style={{justifyContent: "right", alignItems: "right", fontStyle: "normal", fontWeight:"400", fontSize: "12px", lineHeight: "120%", color: "white", marginLeft: "45px"}}>{`${item.pegMechanism.charAt(0).toUpperCase()}${item.pegMechanism.toString().slice(1)}`}</Text>
                    </View>
                    <View style={{width: "57px", justifyContent: "right", alignItems: "right"}}>
                      <Text style={{justifyContent: "right", alignItems: "right", fontStyle: "normal", fontWeight:"400", fontSize: "12px", lineHeight: "120%", color: "white", marginLeft: "65px"}}>${convertToInternationalCurrencySystem(item.chainCirculating?.Solana?.current?.peggedUSD)}</Text>
                    </View>
                    <View style={{width: "57px", justifyContent: "right", alignItems: "right"}}>
                      <Text style={{justifyContent: "right", alignItems: "right", fontStyle: "normal", fontWeight:"400", fontSize: "12px", lineHeight: "120%", color: "white", marginLeft: "85px"}}>${`${item.price.toString().slice(0,4)}`}</Text>
                    </View>
                </View>
