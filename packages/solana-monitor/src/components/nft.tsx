                    ...
                    <View style={{display:"flex", flexDirection: "column"}}>
                      ...
                      <View style={{display: "flex", flewDirection :"row", marginTop: "3.5px"}}>
                        ...
                        >
                          ...
                          >
                            {(item.floorPrice / 10 ** 7).toLocaleString("en-US")}
                          </Text>
                        </View>
                      </View>
                    </View>
                    {/* <View
                      style={{ display: "flex", flexDirection: "row", gap: 5, marginLeft: "9%", marginRight: "25px"}}
                    >
                      <Image
                        style={{
                          width: "20px",
                      ...
                      <Text
                        style={{fontWeight: "600", fontSize: "14px", lineHeight: "120%", marginTop: "2px",}}
                      >
                        {(item.volume / 10 ** 7).toLocaleString("en-US")}
                      </Text>
                    </View> */}
                </View>
