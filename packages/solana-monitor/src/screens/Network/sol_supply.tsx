  ...
  return (
    <View style={{ height: "100%", alignItems: "center", justifyContent: "center"}}>
        ...
        <View style={{flex: "1", paddingTop: "11px", paddingLeft:"12px", paddingRight: "11px", width: "343px", marginLeft: "16px", marginTop: "20px", background: "rgba(255, 255, 255, 0.04)", border: "1px solid rgba(255, 255, 255, 0.04)", backdropFilter: "blur(30px)", borderRadius: "8px"}}>
          ...
          <View style={{marginTop: "11px", width: "100%", height: "1px", background: "rgba(255, 255, 255, 0.06)"}}></View>
          <Text style={{fontWeight: "700", fontSize: "18px", lineHeight: "150%", marginTop: "12px"}}>{data?.data.solSupply.circulating.toLocaleString('en-US')}</Text>
          <View style={{display: "flex", flexDirection: "row", marginTop: "6px", marginBottom: "15px"}}>
            ...
            <Text style={{alignItems: "center", textAlign: "center", fontWeight: "400", marginLeft:"4px", fontSize: "18px", lineHeight: "150%", color: "rgba(255,255,255, 0.85)"}}>
              is circulating
            </Text>
          </View>
        </View>
        <View style={{flex: "1", paddingTop: "11px", paddingLeft:"12px", paddingRight: "11px", width: "343px", marginLeft: "16px", marginTop: "20px", background: "rgba(255, 255, 255, 0.04)", border: "1px solid rgba(255, 255, 255, 0.04)", backdropFilter: "blur(30px)", borderRadius: "8px"}}>
          ...
          <View style={{marginTop: "11px", width: "100%", height: "1px", background: "rgba(255, 255, 255, 0.06)"}}></View>
          <Text style={{fontWeight: "700", fontSize: "18px", lineHeight: "150%", marginTop: "12px", marginBottom: "15px"}}>{data?.data.solSupply.nonCirculating.toLocaleString('en-US')}</Text>
        </View>
    </View>
  );
}
